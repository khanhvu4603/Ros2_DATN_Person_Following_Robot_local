...
class PersonDetector(Node):
    def __init__(self):
        ...
        self.declare_parameters('', [
            ...
            ('reject_threshold', 0.65), # Ngưỡng để từ chối khi đã lock
    ...
    def on_image(self, msg: Image):
        ...
        if self.state == 'SEARCHING':
            ...
            if self.is_target_occluded(self.target_box, depth_frame, self.last_known_depth):
                ...
                self.start_lost_sound_loop()  # Start playing lost sound
            ...
            if time.time() - self.lost_start_time > self.get_parameter('grace_period_sec').value:
                ...
                # Note: Lost sound continues playing in SEARCHING state
                # until target is found (transitioned to LOCKED)
