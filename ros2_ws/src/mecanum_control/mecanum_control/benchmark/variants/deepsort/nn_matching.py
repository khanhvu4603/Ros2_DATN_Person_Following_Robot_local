"""
Nearest neighbor matching for appearance features.
"""
...
class NearestNeighborDistanceMetric:
    """
    A nearest neighbor distance metric that computes distances between tracks and detections.
    ...
    matching_threshold : float
        The matching threshold for valid associations.
    budget : Optional[int]
        If not None, fix samples per class to most recent (FIFO).
