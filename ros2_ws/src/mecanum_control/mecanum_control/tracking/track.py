...
class Track:
    ...
    def update(self, kf, detection, feature=None):
        ...
        # Detect sudden stop: velocity > 3 px/frame but displacement < 50% of expected
        ...
        # === VELOCITY DAMPING: Gradually reduce velocity each frame ===
        # This prevents velocity from accumulating and causing drift
        self.mean[4:8] *= 0.9  # 10% reduction per frame
