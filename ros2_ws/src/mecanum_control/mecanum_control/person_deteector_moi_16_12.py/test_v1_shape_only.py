...
# -*- coding: utf-8 -*-
"""
Video Tracker Test - V1: Shape Only (MobileNetV2 1280-dim)
Test tracking trên video với feature chỉ từ MobileNetV2.

Usage:
    python3 test_v1_shape_only.py --video /path/to/video.mp4
"""
...
def extract_shape_feature(frame, box, ort_sess):
    """V1: Chỉ MobileNetV2 - 1280-dim"""
...
class VideoTracker:
    ...
    def enroll(self, frame, boxes):
        ...
        feat = extract_shape_feature(frame, box, self.mb2_sess)
        if feat is not None:
...
# ========== Main ==========
def main():
    parser = argparse.ArgumentParser(description='Test V1: Shape Only')
    ...
    parser.add_argument('--output', type=str, default='results_v1_shape.csv')
    parser.add_argument('--show', action='store_true', help='Show video')
    args = parser.parse_args()
    
    print(f"=== V1: Shape Only (MobileNetV2 1280-dim) ===")
    ...
    while True:
        ...
        if args.show:
            ...
            cv2.imshow('V1: Shape Only', frame)
