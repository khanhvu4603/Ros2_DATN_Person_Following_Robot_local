...
setup(
    name=package_name,
    version='0.0.0',
    packages=[package_name, f'{package_name}.tracking', f'{package_name}.core', f'{package_name}.nodes'],
    package_data={
        package_name: [
            'models/*',
            'sounds/*',
    ...
    entry_points={
        'console_scripts': [
            ...
            'lidar_processor   = mecanum_control.nodes.lidar_processor_node:main',
            ...
            'person_detector   = mecanum_control.nodes.person_detector_node:main',
            'stm32_communicator= mecanum_control.nodes.stm32_node:main',
